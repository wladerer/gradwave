# VENDORED from PR #265 (branch moonshot-dtn-1d) experiments/dtn_1d/jellium_slab.py
# Validated 1D jellium-slab DtN/ESM primitives (poisson, kinetic, fill, total_energy).
# Reused here for the DG-ALB adsorbate-binding spike (coordination — see FINDINGS.md).
# Do not edit; update by re-vendoring from #265.
