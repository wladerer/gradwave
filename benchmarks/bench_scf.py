"""SCF benchmark: Si LDA, 30 Ry, 4x4x4 (36 k TR-reduced; 8 k with symmetry).

Usage: uv run python benchmarks/bench_scf.py [cpu|cuda] [threads] [sym|nosym]
"""
...
print(f"device={device} threads={threads} sym={use_sym} nk={len(system.spheres)}")
