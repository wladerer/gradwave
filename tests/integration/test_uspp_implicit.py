"""dE/dθ through the USPP/PAW SCF by stationarity (task #58, milestone 1).

Functional-parameter gradients at the converged generalized SCF point:
...
from gradwave.postscf.uspp_implicit import uspp_energy_param_grads
