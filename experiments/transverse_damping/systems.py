"""System builders for the transverse-damping study.

Reused verbatim from the noncollinear_convergence campaign so this study
measures the same cells at the same settings. Every cell is a 1-atom (Pt/Ni/Fe
fcc/bcc) or 2-atom (bcc canted) primitive with a modest ecut / k-mesh: a
convergence-BEHAVIOUR study, not a QE-accuracy benchmark. Pseudos are the
